...
export const SLIDES: Slide[] = [
  ...
  { slug: 'template-functions', title: 'Template Functions', image: 'templateFn.png' },
  { slug: 'template-compiler', title: 'Template Compiler', image: 'template-compiler.png' },
  { slug: 'lview-where-angular-remembers-values', title: 'LView: Where Angular Remembers Values', image: 'lview-where-angular-remembers-values.png' },
  { slug: 'how-a-binding-update-reaches-the-dom', title: 'How a Binding Update Reaches the DOM', image: 'how-a-binding-update-reaches-the-dom.png' },
  ...
  { slug: 'the-real-lesson', title: 'Unidirectional Data Flow', image: 'the-real-lesson.png' },
  ...
  { slug: 'templates-become-reactive-consumers', title: 'Templates Run With a Reactive Consumer', image: 'templates-become-reactive-consumers.png' },
